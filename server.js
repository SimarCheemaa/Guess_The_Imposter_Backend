...
//     sessions[code] = { players: [name] };
//     console.log(sessions[code].players);
//     console.log(name);
//     console.log(code);
//     res.send({ code });
// });
...
//         res.send({ success: true, players: sessions[code].players });
//     } else {
...
//     res.send({ category: randomCategory, word: randomWord, imagePath: imagePath });
// });
...
//     const { code, name } = req.body;
//     if (sessions[code]) {
//         const player = sessions[code].players.find(player => player.name === name);
//         if (player) {
//             player.ready = true;

//             // Check if all players are ready
//             const allReady = sessions[code].players.every(player => player.ready);
//             if (allReady && !sessions[code].started) {
//                 startGame(code);
//             }
...
//     session.imposter = session.players[imposterIndex].name;
...
//     const words = Object.keys(gameData[randomCategory]);
//     const randomWord = words[Math.floor(Math.random() * words.length)];
//     session.category = randomCategory;
//     session.word = randomWord;

//     console.log(`Game started in session ${code}. Imposter: ${session.imposter}. Category: ${session.category}. Word: ${session.word}`);
// }
